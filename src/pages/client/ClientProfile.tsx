...
const handlePasswordValidation = () => {
  ...
  if (result.isValid) {
    try {
        const response = await clientService.updateProfile(profile);
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="space-y-5">
            ...
            <button
              ...
              className="flex items-center justify-center w-full px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-medium rounded-lg hover:from-blue-600 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 shadow-md hover:shadow-lg"
            >
