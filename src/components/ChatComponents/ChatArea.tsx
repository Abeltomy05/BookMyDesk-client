        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            {selectedSession?.avatar ? (
              <img
                src={`${import.meta.env.VITE_CLOUDINARY_SAVE_URL}${selectedSession.avatar}`}
       ...
       <div key={msg._id} className={`flex ${isMyMessage(msg) ? 'justify-end' : 'justify-start'}`}>
        ...
        // Deleted message UI
            ...
            <div className="relative group max-w-xs lg:max-w-md px-4 py-2 rounded-lg transition-colors"
                ...
                {msg.image && <img src={`${import.meta.env.VITE_CLOUDINARY_SAVE_URL}${msg.image}`} alt="Shared" className="chat-message-image max-w-full h-auto mt-1 rounded-lg" />}
